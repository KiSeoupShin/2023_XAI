...
# @click.option("-m", "--model-path", type=click.Path(exists=True), required=False, help="path to model weight.")
...
def main(
    ...
    model = TubeViTLightningModule.load_from_checkpoint("tubevit_b_01.pt")
