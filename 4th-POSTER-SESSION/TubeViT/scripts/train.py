...
@click.option("-nc", "--num-classes", type=int, default=50, help="num of classes of dataset.")
@click.option("-b", "--batch-size", type=int, default=64, help="batch size.")
...
def main(
    ...
    train_metadata_file = "ucf50-train-meta.pickle"
    ...
    val_metadata_file = "ucf50-val-meta.pickle"
